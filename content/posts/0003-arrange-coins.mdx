...
import { Init, Observe, State } from 'mdx-observable';

<State initialState={{ activeTabIndex: 0 }}>
...
<!-- Source: https://codesandbox.io/s/gatsby-mdx-tabs-linked-state-demo-85ewx?file=/src/pages/mdx-tabs-demo.mdx -->
## Tab Group A
...
<Observe>
  {({ setState, ...state }) => (
    <Tabs
      ...
      onChange={newIndex => setState({activeTabIndex: newIndex})}
    >
      <TabList>
        <Tab>1</Tab>
        <Tab>2</Tab>
